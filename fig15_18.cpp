...
int main() {
   ...
   auto result1 = foldingSum(1, 2, 3); // valid: all are int values
   std::cout << "Sum of integers: " << result1 << std::endl;
   auto result2 = foldingSum("s"s, "u"s, "m"s); // valid: all are std::string objects
   std::cout << "Concatenation of strings: " << result2 << std::endl;
